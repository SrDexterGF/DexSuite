...
public sealed class M15Performance : ModuleExecutorBase
{
        ...
        [EnumeratorCancellation] CancellationToken ct = default)
    {
        ...
        if (Want(enabledSubOps, "M15_power_throttle"))
        {
        ...
        if (Want(enabledSubOps, "M15_mmcss"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_gamemode"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_timeouts"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_maintenance"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_hibernate"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_sync"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_transparency"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_bg_apps"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_input_telemetry"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_hags"))
        {
        ...
        if (ct.IsCancellationRequested) yield break;
        if (Want(enabledSubOps, "M15_diag_svc"))
        {
